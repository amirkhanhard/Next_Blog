          ...
          <main className="flex-grow bg-gray-50 py-8 px-4 w-1/2 mx-auto text-center">
            ...
            <div className="space-y-8">
              ...
              // {
               ...
               (<article key={value.shortDescription} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-sm text-gray-500">
                      <i className="far fa-calendar-alt mr-1" /> May 15, 2023 <Link href={`blog/${value.slug}`} class="text-blue-600">Read More</Link>
                    </div>
                  </div>
                </div>
              </article>)
